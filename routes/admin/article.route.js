...
router.post("/create", upload.fields([{ name: "image", maxCount: 1 }]), uploadFields, controller.createPost);

// [PATCH] /api/admin/articles/:id – Cập nhật
router.patch("/:id", upload.fields([{ name: "image", maxCount: 1 }]), uploadFields, controller.editPatch);
